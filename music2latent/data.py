...
def get_dataloader(batch_size_per_gpu):
    ...
    if hparams.use_contrastive:
        ...
        dataset = AudioDataset(hparams.data_paths, hparams.hop, 4, hparams.data_length, 
                             hparams.data_fractions, hparams.rms_min, hparams.data_extensions, 
                             hparams.iters_per_epoch*hparams.batch_size)
