# CODE ADAPTED FROM https://github.com/gudgud96/frechet-audio-distance/blob/main/frechet_audio_distance/fad.py
...
class FrechetAudioDistance:
    def __init__(
        ...
        -- model_name: one between vggish, clap
        ...
        """
        assert model_name in ["vggish", "clap"], "model_name must be either 'vggish', 'clap'"
    ...
    def get_embeddings(self, x, sr):
        """
        Get embeddings using VGGish, CLAP models.
        Params:
